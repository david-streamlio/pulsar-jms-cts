...
public class Coverage implements java.io.Serializable {
     ...
     * @param vTest
     */
    public void addTest(String vTest)
     ...
     * @param vTest
     */
    public void addTest(int index, String vTest)
        throws IndexOutOfBoundsException
    {
     ...
     * @param vTest
     */
    public void setTest(int index, String vTest)
        throws IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _testList.size())) {
    ...
    public static Coverage unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (Coverage) Unmarshaller.unmarshal(Coverage.class, reader);
