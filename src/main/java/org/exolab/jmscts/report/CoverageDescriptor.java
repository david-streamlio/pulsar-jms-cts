...
public class CoverageDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CoverageDescriptor() {
        ...
        //-- _runs
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(Integer.TYPE, "_runs", "runs", org.exolab.castor.xml.NodeType.Attribute);
        ...
        //-- _failures
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(Integer.TYPE, "_failures", "failures", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
            {
        ...
        desc.setValidator(fieldValidator);
        //-- _supported
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(Boolean.TYPE, "_supported", "supported", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
            {
        ...
        //-- _requirementId
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_requirementId", "requirementId", org.exolab.castor.xml.NodeType.Element);
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Coverage target = (Coverage) object;
                    target.setRequirementId( (String) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
        //-- _testList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_testList", "test", org.exolab.castor.xml.NodeType.Element);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
     ...
     * Method getJavaClass
     */
    public Class<Coverage> getJavaClass()
    {
