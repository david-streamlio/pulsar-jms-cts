...
public class FactoryDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FactoryDescriptor() {
        ...
        //-- _user
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_user", "user", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
        ...
        desc.setValidator(fieldValidator);
        //-- _password
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_password", "password", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
     ...
     * Method getJavaClass
     */
    public Class<Factory> getJavaClass()
    {
