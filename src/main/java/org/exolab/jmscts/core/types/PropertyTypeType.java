...
public class PropertyTypeType implements java.io.Serializable {
     ...
     * Field _memberTable
     */
    private static Hashtable<String, PropertyTypeType> _memberTable = init();
    ...
    private PropertyTypeType(int type, String value) {
        super();
        this.type = type;
     ...
     * Method init
     */
    private static Hashtable<String, PropertyTypeType> init()
    {
     ...
     * @param string
     */
    public static PropertyTypeType valueOf(String string)
    {
        Object obj = null;
