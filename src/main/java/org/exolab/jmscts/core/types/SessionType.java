...
public class SessionType implements java.io.Serializable {
     ...
     * Field _memberTable
     */
    private static Hashtable<String, SessionType> _memberTable = init();
    ...
    private SessionType(int type, String value) {
        super();
        this.type = type;
     ...
     * Method init
     */
    private static Hashtable<String, SessionType> init()
    {
