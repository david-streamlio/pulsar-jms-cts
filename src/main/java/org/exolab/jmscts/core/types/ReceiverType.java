...
public class ReceiverType implements java.io.Serializable {
     ...
     * Field _memberTable
     */
    private static Hashtable<String, ReceiverType> _memberTable = init();
    ...
    private ReceiverType(int type, String value) {
        super();
        this.type = type;
     ...
     * Method init
     */
    private static Hashtable<String, ReceiverType> init()
    {
     ...
     * @param string
     */
    public static ReceiverType valueOf(String string)
    {
        Object obj = null;
