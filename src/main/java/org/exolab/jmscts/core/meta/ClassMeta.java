 ...
 */
public class ClassMeta extends Meta
implements java.io.Serializable
{
     ...
     */
    private ArrayList<MethodMeta> _methodMetaList;
     ...
     * @param vMethodMeta
     */
    public void addMethodMeta(int index, MethodMeta vMethodMeta)
        throws IndexOutOfBoundsException
    {
    ...
    public MethodMeta[] getMethodMeta()
    {
        ...
        MethodMeta[] mArray = new MethodMeta[size];
     ...
     * @param vMethodMeta
     */
    public void setMethodMeta(int index, MethodMeta vMethodMeta)
        throws IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _methodMetaList.size())) {
    ...
    public static ClassMeta unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (ClassMeta) Unmarshaller.unmarshal(ClassMeta.class, reader);
