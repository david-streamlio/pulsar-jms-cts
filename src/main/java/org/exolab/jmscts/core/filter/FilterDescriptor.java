...
public class FilterDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FilterDescriptor() {
        ...
        //-- _excludeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(Exclude.class, "_excludeList", "exclude", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Filter target = (Filter) object;
                    target.addExclude( (Exclude) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
     ...
     * Method getJavaClass
     */
    public Class<Filter> getJavaClass()
    {
        return Filter.class;
