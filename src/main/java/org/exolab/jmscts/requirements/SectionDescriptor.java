...
public class SectionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SectionDescriptor() {
        ...
        //-- _title
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_title", "title", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
     ...
     * Method getJavaClass
     */
    public Class<Section> getJavaClass()
    {
