...
public class Requirement implements java.io.Serializable {
     ...
     */
    private ArrayList<RequirementChoice> _requirementChoiceList;
     ...
     * @param vRequirementChoice
     */
    public void addRequirementChoice(int index, RequirementChoice vRequirementChoice)
        throws IndexOutOfBoundsException
    {
     ...
     * @param vRequirementChoice
     */
    public void setRequirementChoice(int index, RequirementChoice vRequirementChoice)
        throws IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _requirementChoiceList.size())) {
    ...
    public static Requirement unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (Requirement) Unmarshaller.unmarshal(Requirement.class, reader);
