...
public class Document implements Serializable {
     ...
     *
     */
    private ArrayList<Serializable> _includeList;

    /**
     * This element specifies a requirement reference.
     *
     */
    private ArrayList<Serializable> _referenceList;
     ...
     *
     */
    private ArrayList<Serializable> _requirementList;
     ...
     * @param vRequirement
     */
    public void addRequirement(int index, Requirement vRequirement)
        throws IndexOutOfBoundsException
    {
        ...
        throws IndexOutOfBoundsException
    {
        ...
        return (Requirement) _requirementList.get(index);
    ...
    public Requirement[] getRequirement()
    {
        ...
        Requirement[] mArray = new Requirement[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (Requirement) _requirementList.get(index);
        }
        return mArray;
     ...
     * @param vRequirement
     */
    public void setRequirement(int index, Requirement vRequirement)
        throws IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _requirementList.size())) {
    ...
    public static Document unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (Document) Unmarshaller.unmarshal(Document.class, reader);
