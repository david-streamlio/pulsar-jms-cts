...
public class RequirementDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public RequirementDescriptor() {
        ...
        //-- _requirementId
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_requirementId", "requirementId", org.exolab.castor.xml.NodeType.Attribute);
        ...
        //-- _optional
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(Boolean.TYPE, "_optional", "optional", org.exolab.castor.xml.NodeType.Attribute);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
            {
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(RequirementChoice.class, "_requirementChoiceList", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public Object getValue( Object object )
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Requirement target = (Requirement) object;
                    target.addRequirementChoice( (RequirementChoice) value);
                }
                catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public Object newInstance( Object parent ) {
                return new RequirementChoice();
            }
        } );
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new RequirementChoiceDescriptor());
        desc.setRequired(true);
     ...
     * Method getJavaClass
     */
    public Class<Requirement> getJavaClass()
    {
